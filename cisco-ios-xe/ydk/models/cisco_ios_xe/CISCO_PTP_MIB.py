        ...
        class Cptpclockcurrentdsentry(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ...
                    ('cptpclockcurrentdsoffsetfrommain', YLeaf(YType.str, 'cPtpClockCurrentDSOffsetFromMain')),
        ...
        class Cptpclockdefaultdsentry(Entity):
            ...
            def __init__(self):
                ...
                self._leafs = OrderedDict([
                    ...
                    ('cptpclockdefaultdssubordinateonly', YLeaf(YType.boolean, 'cPtpClockDefaultDSSubordinateOnly')),
