        ...
        class Node(Entity):
            ...
            class GroupIdXr(Entity):
                ...
                class GroupId(Entity):
                    ...
                    def __setattr__(self, name, value):
                        self._perform_setattr(SessionRedundancyAgent.Nodes.Node.GroupIdXr.GroupId, ['group_id', 'group_id_xr', 'interface_name', 'key_index', 'role_main', 'negative_acknowledgement_update_all'], name, value)
